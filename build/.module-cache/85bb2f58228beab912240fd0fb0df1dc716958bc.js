...
var jobData =[
	{job:"Web Developer",
	project:
		[{name:"Hypo",link:"http://hypo.cc/"},
		{name:"Pieces",link:"http://pieces.hypo.cc/"}],
...
var ProjectList = React.createClass({displayName: "ProjectList",
	render:function(){
		...
		var nodes = this.props.list_data.map(function(project){
			return(
				React.createElement("li", null, 
					React.createElement("a", {target: "_blank", href: project.link}, project.name)
				)	
			);
	...
	render:function(){
		return(
			React.createElement("div", {className: "skill-box"}, 
				...
				React.createElement("ul", null, 
					React.createElement("li", null, 
					"Have experiences in developing under MVC framework (Ruby on RailsC)."
					)
				)
			)
		);
