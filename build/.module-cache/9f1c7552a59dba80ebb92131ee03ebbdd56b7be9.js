	...
	render:function(){
		return(
			React.createElement("div", {className: "contact-box"}, 
				...
				React.createElement("ul", null, 
				React.createElement("li", null, React.createElement("a", {target: "_blank", href: "mailto:eva091960601@gmail.com"}, React.createElement("i", {className: "fa fa-envelope fa-3x"}))), 
